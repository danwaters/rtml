...
using RealtimeMoodLighting.Pages;
...
[assembly: ExportRenderer(typeof(RealtimeMoodLighting.Pages.CameraPage), typeof(RealtimeMoodLighting.iOS.Pages.CameraPage))]
namespace RealtimeMoodLighting.iOS.Pages
{
	public class CameraPage : PageRenderer
	{
        ...
        {
            takePhotoButton.BackgroundColor = UIColor.Black;
		...
		{
            RealtimeMoodLighting.iOS.Services.FaceUploader.Upload(image);
		}
	}
}